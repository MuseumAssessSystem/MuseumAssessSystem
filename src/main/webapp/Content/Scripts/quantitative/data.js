...
$(function(){
    $(".dl_all").makeSortable3();
    $(".dx_one").makeSortable1();
    $(".dl_two").makeSortable1();
    $(".dl_one_type").makeSortable2();
    $(".dl_one_level").makeSortable2();
    $(".dl_two_type").makeSortable2();
    $(".dl_two_level").makeSortable2();
});
$(function () {
